...
def create_tables(dbfs_file_location=dbfs_file_locations):
  ...
  delta_tables = {"ticket":       "ohamdan_fs_demo.passenger_ticket_features",
                  "demographic":  "ohamdan_fs_demo.passenger_demographic_features",
                  "labels":       "ohamdan_fs_demo.passenger_labels"}
...
# MAGIC %sql
# MAGIC Create database IF not exists ohamdan_FS_demo;
# MAGIC USE ohamdan_FS_demo
...
# MAGIC %sql
# MAGIC 
# MAGIC -- DROP TABLE IF EXISTS ohamdan_fs_demo.passenger_ticket_feautures;
# MAGIC -- DROP TABLE IF EXISTS ohamdan_fs_demo.passenger_demographic_feautures;
